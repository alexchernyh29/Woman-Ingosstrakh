...
$(() => {
    ...
    $(".test__img").html(
        `<img src="/images/карточки-мобилка-1.jpg" alt="Large Image" />`
        );
    } else {
    $(".test__img").html(
        `<img src="/images/карточки-десктоп-1.jpg" alt="Large Image" />`
        );
    }
	$('.test__wrap').slick({
        infinite: true, 
    ...
    const DATA = [
        {
            ...
            image: "/images/карточки-десктоп-1.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-2.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-3.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-4.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-5.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-6.jpg",
        ...
        },
        {
            ...
            image: "/images/карточки-десктоп-7.jpg",
