...
$(() => {
    ...
    $(".test__img").html(
        `<img src="/images/карточки-мобилка-1.png" alt="Small Image" />`
        );
    } else {
    $(".test__img").html(
    ...
    const DATA = [
        {
            ...
            smallImage: "/images/карточки-мобилка-1.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-2.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-3.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-4.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-5.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-6.png",
        },
        {
            ...
            smallImage: "/images/карточки-мобилка-7.png",
        },
    ];
